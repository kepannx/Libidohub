...
(function (e, t) {
	function u() {
		if (r)
			...
			e.each(s, function (e, r) {
				...
				if (t.css("backgroundImage").match("gradient"))
					return i = e, !1
	...
	function h(t) {
		...
		if (t.length <= 2 || e.inArray(!1, t) < 0)
			return t;
		while (i < t.length - 1)
			!s && t[i] === !1 ? (n = i - 1, s = !0) : s && t[i] !== !1 && (r = i, i = t.length), i++;
	...
	if (r && parseInt(e.browser.version, 10) <= 7)
		return e.fn.iris = e.noop;
	...
	var p = {options     : {color: !1, mode: "hsl", controls: {horiz: "s", vert: "l", strip: "h"}, hide: !0, border: !0, target: !1, width: 200, palettes: !1}, _palettes: ["#000", "#fff", "#d33", "#d93", "#ee2", "#81d742", "#1e73be", "#8224e3"], _inited: !1, _scale: {h: 360, s: 100, l: 100, v: 100}, _create: function () {
		...
		if (t === n.active || n.active === "square" && t !== "strip")
			return;
		switch (u[t]) {
			case"h":
				if (i === "hsv") {
					...
					t === "strip" ? a = {s: s.s, l: s.l} : a = {s: 100, l: s.l};
	...
	n.fn = n.prototype = {_color   : 0, _alpha: 1, error: !1, _hsl: {h: 0, s: 0, l: 0}, _hsv: {h: 0, s: 0, v: 0}, _hSpace: "hsl", _init: function (e) {
		...
		if (typeof e != "object" || e.h === t || e.s === t || e.v === t)
			return this._error();
		...
		var r = 0 === n.toInt() ? 1 : -1;
		while (e > t)
			n = n.incrementLightness(r), e = n.getDistanceLuminosityFrom(this);
		return n
	...
	for (var i in r)
		r.hasOwnProperty(i) && (n.fn[i] = n.fn._partial(i));
	e.Color = n
