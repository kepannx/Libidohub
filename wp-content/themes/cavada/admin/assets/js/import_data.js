...
function import_type(type, method) {
	jQuery.ajax({
		...
		success: function (response) {
			...
			{
				var msg = 'Import finish without revolution sliders.You can import manual, please view http://villatheme.com/knowledge-base/.';
				...
				if( response.message ) {
					...
					jQuery('#tp_process_error_messase').append('Import error. Please go to http://villatheme.com/support to get the best support.');
					alert('Import error. Please go to http://villatheme.com/support to get the best support.');
				}
			}
		},
		error  : function (html) {
			jQuery('#tp_process_error_messase').append('Import error. Please go to http://villatheme.com/forums to get the best support.');
