...
class viHTML extends viBase {
	...
	public function read($options) {
		...
		$this->forcexhtml = (bool) apply_filters( 'vi_filter_html_forcexhtml', false );
		
		// filter to add strings to be excluded from HTML minification
		$excludeHTML = apply_filters( 'vi_filter_html_exclude','' );
                if ($excludeHTML!=="") {
	...
	public function minify() {
                $noptimizeHTML = apply_filters( 'vi_filter_html_noptimize', false, $this->content );
                if ($noptimizeHTML)
                        return false;
